...
public class MotorShip
{
	...
	public Color getMainColord() { return mainColor; }
	private Color additionalColor;
	public Color getAdditionalColor() { return additionalColor; }

	private boolean additionalBoat;
	public boolean getAdditionalBoat() { return additionalBoat; }
	private boolean helicopterPad;
	public boolean getHelicopterPad() { return helicopterPad; }
	...
	private Pipes pipes;
	public int getPipeCount() { return pipes.getPipeCount(); }
	public void setPipeCount(int count) { pipes.setPipeCount(count); }
	public void setPipeCount(PipeCount pipeCount) { pipes.setPipeCount(pipeCount); }
	...
	public void drawTransport(Graphics g)
	{
		...
		{
			boatPolygonPointsX[0] = posX - (shipHeight * 2 / 3); 	boatPolygonPointsY[0] = posY - (shipWidth / 2);
			boatPolygonPointsX[1] = posX + (shipHeight * 2 / 3);	boatPolygonPointsY[1] = posY - (shipWidth / 2);
			boatPolygonPointsX[2] = posX + shipHeight; 				boatPolygonPointsY[2] = posY;
			boatPolygonPointsX[3] = posX + (shipHeight * 2 / 3); 	boatPolygonPointsY[3] = posY + (shipWidth / 2);
			boatPolygonPointsX[4] = posX - (shipHeight * 2 / 3); 	boatPolygonPointsY[4] = posY + (shipWidth / 2);
			boatPolygonPointsX[5] = posX - shipHeight; 		 		boatPolygonPointsY[5] = posY;
		}
		else
		{
			boatPolygonPointsX[0] = posX - (shipWidth / 2); 		boatPolygonPointsY[0] = posY - (shipHeight * 2 / 3);
			boatPolygonPointsX[1] = posX - (shipWidth / 2); 		boatPolygonPointsY[1] = posY + (shipHeight * 2 / 3);
			boatPolygonPointsX[2] = posX; 							boatPolygonPointsY[2] = posY + shipHeight;
			boatPolygonPointsX[3] = posX + (shipWidth / 2); 		boatPolygonPointsY[3] = posY + (shipHeight * 2 / 3);
			boatPolygonPointsX[4] = posX + (shipWidth / 2); 		boatPolygonPointsY[4] = posY - (shipHeight * 2 / 3);
			boatPolygonPointsX[5] = posX; 							boatPolygonPointsY[5] = posY - shipHeight;
		}		
		...
		if (additionalBoat)
		{
			...
			if (lastDirection == Direction.Left || lastDirection == Direction.Right)
			{
				boatPointX = posX - (shipHeight * 2 / 3); boatPointY = posY + (shipWidth / 2);
				g.fillOval(boatPointX, boatPointY, (int)(shipHeight / 3), (int)(shipWidth / 3));
			}
			else
			{
				boatPointX = posX + (shipWidth / 2); boatPointY = posY  - (shipHeight * 2 / 3);
